...
namespace Assignment_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nNumber of shares :" + client1.StockList.Length());
            ...
            Console.WriteLine("\nPortfolio sorted in descending order by number of holdings for client 1:");
            client1.StockList.Print();
            ...
            Console.WriteLine("\nNumber of shares :" + client2.StockList.Length());
            ...
            Console.WriteLine("\nPortfolio sorted in descending order by number of holdings for client 2:");
            client2.StockList.Print();
            client2.StockList.SortByName();
            Console.WriteLine("\nPortfolio sorted in alphabatical order for client 2:");
            client2.StockList.Print();
            Console.WriteLine();

            Console.WriteLine("Similarity Index for Client-1 and Clien-2 :" + client1.StockList.Similarity(client2.StockList));

            Console.WriteLine("\n\n**************************Client-1,Client -2 Merged Portfolio*****************************************");
